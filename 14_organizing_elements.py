...
col_buttons = [
        ...
        [sg.Frame("list of sequences in your alignment", [ [sg.T()] ], key="-list_of_seq-")],
...
layout = [[sg.Column(col_buttons, element_justification="left" ),
           sg.Column(col_plot, element_justification="left")]]



#layout = [[sg.FileBrowse(), sg.Button("get seq names", key="-get_seq_names-")]]
