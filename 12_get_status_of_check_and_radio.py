...
window = sg.Window('12', layout, resizable=True)
...
while True:
    ...
    try: 
        ...
        if event in (sg.WIN_CLOSED, 'Exit'):  # always,  always give a way out!
            ...
            potential_recombinant = get_pot_rec_id(checkboxes_and_radiobuttons, values)
            print("potential recombinant: ", potential_recombinant)
